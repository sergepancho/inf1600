...
matrix_multiply_asm:
        ...
        push %ebx
        sub $16, %esp /* espace pour les variables local r, c , i, elem */
        
        FOR:
        movl $0, -8(%ebp) /* initialise r a zero*/
        movl $0, -12(%ebp) /* initialise c a zero*/
        movl $0, -16(%ebp) /* initialise i a zero*/
        movl $0, (%esp) /* initialise elem a zero*/
        movl 20(%ebp), %ecx /*transfert la valeur matorder dans ecx*/
                FOR_TEST_R:
                cmp %ecx, -8(%ebp) /* il compare r avec matorder */
                jge END_FOR_TEST_R /* sort de la boucle si r >= matorder*/
                movl $0, -12(%ebp) /* reinitialise c pour la boucle*/
                        FOR_TEST_C:
                        cmp %ecx, -12(%ebp) /* il compare matorder avec c  */
                        jge END_FOR_TEST_C /* sort de la boucle si c >= matorder*/
                                                               
                        /* calcul des valeurs a linterieur du tableau out */
                        movl $0, (%esp) /* initialise elem a zero*/
                        movl $0, -16(%ebp) /* reinitialise i pour la boucle*/
        ...
        mov -4(%ebp), %ebx /* reassigne l'ancienne valeur de ebx*/
